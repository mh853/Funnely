...
export default function HeroSection() {
  return (
    <section id="hero_0" className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 pt-32 pb-20 sm:pt-40 sm:pb-24">
