                  ...
                  messages.map((message) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className={`flex-1 ${isAdmin && !isInternal ? 'text-right' : ''}`}>
            ...
            <CardContent className="pt-6">
              <form onSubmit={handleSendMessage} className="space-y-4">
                <Textarea
                  ...
                  placeholder="답변 또는 내부 노트를 입력하세요..."
                  rows={4}
                  disabled={sending}
                />
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <div className="font-medium text-gray-900">{ticket.company.name}</div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <div className="text-sm font-medium text-gray-700 mb-1">최근 수정</div>
                <div className="text-sm text-gray-900">
