        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          ...
          <div className="prose prose-gray max-w-none space-y-10 text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <p>
                서비스는 스타터(₩19,000/월), 스타터 플러스(₩49,000/월), 프로(₩290,000/월), 프리미엄(₩490,000/월), 커스터마이징(가격 협의) 플랜으로 제공됩니다.
                프로 플랜은 신용카드 등록 없이 7일 무료 체험이 가능합니다. 연간 결제 시 월 결제 대비 약 10% 할인된 금액이 적용됩니다.
              </p>
              <p className="mt-3">
