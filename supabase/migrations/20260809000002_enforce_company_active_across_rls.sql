...
DROP POLICY "Company members can delete their blacklist" ON "phone_blacklist";
...
DROP POLICY "Company members can insert blacklist" ON "phone_blacklist";
...
DROP POLICY "Company members can view their blacklist" ON "phone_blacklist";
